...
Tags: wordpress, admin, menu hide, admin menu, admin menu hide, admin menu show, admin menu plugin
...
== Changelog ==
1. Solved some warning and notices at time of save process at version 4.8.  
